...
class TestBasics(unittest.TestCase):
    def test_days(self):
        ...
        self.assertEqual(is_holiday(date(2023, 1, 1)), "Новогодние каникулы")  # "New Year's Day"
        self.assertEqual(is_holiday(date(2023, 1, 12)), "")  # ""
        self.assertEqual(is_holiday(date(2023, 1, 15)), "Выходной")  # "Weekend"
        self.assertEqual(is_holiday(date(2021, 12, 31)), "Передвинутый выходной")  # "Moved weekend"
        self.assertEqual(
